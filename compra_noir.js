document.addEventListener("DOMContentLoaded", () => {
    ...
    // Datos fijos del Bugatti La Voiture Noire
    const precioAuto = 18700000;
    const interesAnual = 3.5;
    let cuotaMensual = 0;
    ...
    if (formularioCompraForm) {
        formularioCompraForm.addEventListener("submit", function(event) {
            ...
            doc.save(`confirmacion_compra_${nombre}_Bugatti_La_Voiture_Noire.pdf`);
